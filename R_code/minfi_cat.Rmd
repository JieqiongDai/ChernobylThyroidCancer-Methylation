---
title: "Detect differentially methylated cpg islands of categorical phenotype using the tool minfi"
author: "Jieqiong Dai"
...
Phenotype case vs control DMP
```{r,message=FALSE,warning=FALSE}
library(minfi)
load("../data/inital_data.Rdata")
p <- pheno $ pheno
dmp1 <- dmpFinder(beta, pheno = p  , type = "categorical")
